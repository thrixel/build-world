...
- **Roblox Studio**: run the in-place audit and camera tour, show the report and captures, and
  say exactly how to press Play. Do not publish without the user's approval.
